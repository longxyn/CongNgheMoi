...
class SanPham
{
    ...
    static function add($id, $ten, $IdDVT, $IdNCC,$GiaBan,$NgaySX, $soluong,$ChatLuong ,$TrangThai, $id_kho_sp)
    {
        $db = DB::getInstance();
        $query = 'INSERT INTO SanPham(Id, TenSP, IdDVT, IdNCC, GiaBan, NgaySX, SoLuong, ChatLuong, TrangThai, id_kho_sp) 
          VALUES (:id, :ten, :IdDVT, :IdNCC, :GiaBan, :NgaySX, :soluong, :ChatLuong, :TrangThai, :id_kho_sp)';
