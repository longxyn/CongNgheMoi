...
<head>
    ...
    <title>Điều phối Nguyên vật liệu</title>
    <?php
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <button type="submit" name="create-nvl" class="btn btn-success">XÁC NHẬN</button>
        </form>
        <?php
    ...
    if (isset($_POST['create-nvl'])) {
        ...
        foreach ($_SESSION['selectedIds'] as $item) {
            $query = "UPDATE `nvl` SET `id_kho_nvl` = '$newIdKho', `TrangThai` = '1' WHERE `Id` = '$item'";
            ...
            echo "<script>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'index.php?controller=nvl';
                    }
                });
            </script>";
        }
