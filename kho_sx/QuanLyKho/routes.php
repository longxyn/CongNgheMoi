...
$controllers = array(
    ...
    'sanpham'   =>['index','insert','edit','import','dplist','trangchu'],
    ...
    'nvl'   =>['index','insert','edit','dplist','import'],
    'bctk' => ['index','show','insert'],
    'phieumuanvl' => ['index','show','insert','muanvl'],
    'phieukk' => ['index','show','insert',],
    'bckk' => ['index','show','insert',],
